    ...
    for (let i = 0; i <= 7; i++) {
        ...
        dats7_bottom.innerHTML = 
            `<div class="days_footer">
                <div class="days_footer_pic" style="background-image: url(https://mat1.gtimg.com/pingjs/ext2020/weather/pc/icon/weather/day/${data.forecast_24h[i].day_weather_code}.png);"></div>
