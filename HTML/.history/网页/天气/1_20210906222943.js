...
function getData(a, b, c = '') {
    ...
    historys = [{ data_province: a, data_city: b, data_county: c }, ...historys.filter(({ data_city }) => data_city !== b)]
    ...
    p.forEach((item, index) => {
        item.addEventListener('mousedown', () => {
            ...
            //     getData(cityStr[0], cityStr[1])
                ...
                pos.innerHTML = `<p data-county = ${cityStr[2]} data-province = ${cityStr[0]} data-city=${cityStr[1]}} class="pos_data">${cityStr[0]} ${cityStr[1]}</p>`
            }
