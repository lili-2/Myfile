...
hotCity.forEach(function (i) {
    i.addEventListener('mousedown', function () {
        ...
        pos.innerHTML = `<p data-province = ${this.attributes['data-province'].value} data-city=${this.attributes['data-city'].value} data-county=${this.attributes['data-county'].value} class="pos_data">${this.attributes['data-province'].value} ${this.getAttribute['data-city'].value}</p>`
        // } else {
