...
function update(data) {
    ...
    const today_data = [`中央气象台${dayTime.slice(8, 10)}:${dayTime.slice(10, 12)}发布`,`${data.observe.degree}°`,`${data.observe.weather}`,`${winds_arr[data.observe.wind_direction]} ${data.observe.wind_power}级`//wind_direction]
