...
function judgeCity(dom) {
    if (dom.attributes['data-province'].value === dom.attributes['data-city'].value) {
        ...
        pos.innerHTML = `<p data-province = ${this.attributes['data-province'].value} data-city=${this.attributes['data-city'].value}} class="pos_data">${dom.attributes['data-province'].value} ${dom.attributes['data-city'].value}</p>`
    }
}