    ...
    p.forEach((item, index) => {
        item.addEventListener('mousedown', () => {
            ...
            //     getData(cityStr[0], cityStr[1])
                ...
                // pos.setAttribute('data_city', cityStr[0]cityStr[0])
                pos.innerHTML = `<p data-province = ${cityStr[0]} data-city=${this.attributes['data-city'].value}} class="pos_data">${this.attributes['data-province'].value} ${this.attributes['data-city'].value}</p>`
