...
hotCity.forEach(function (i) {
    i.addEventListener('mousedown', function () {
        ...
        pos.innerHTML = `<p data-province = ${this.getAttribute['data-province']} data-city=${this.getAttribute['data-city']} data-county=${this.getAttribute['data-county'].v} class="pos_data">${this.getAttribute['data-province'].value} ${this.getAttribute['data-city'].value}</p>`
        // } else {
