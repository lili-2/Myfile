...
function judgeCity(dom) {
    if (dom.attributes['data-province'].value === dom.attributes['data-city'].value) {
        ...
        pos.innerHTML = `<p data-province = ${dom.attributes['data-province'].value} data-city=${dom.attributes['data-city'].value}} class="pos_data" ${dom.attributes['data-city'].value} data-county = ${dom.attributes['data-county'].value}</p>`
    }else{
