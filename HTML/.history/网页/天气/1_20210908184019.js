...
function update(data) {
    ...
    btn_r1[0].addEventListener('click',() => btnFunr(hoursListEle,1045))
    ...
    btn_r1[1].addEventListener('click',() => btnFunr(hoursListEle,380))
...
// function btnFun(dom,directon,){
//     if (parseInt(dom.style.left) + parseInt(dom.offsetWidth) < 2090) {
//         dom.style.left = `-${dom.offsetWidth - 1140}px`
//     } else {
//         dom.style.left = `${dom.style.left - 1045}px`
//     }
// }
// btnFunr(hoursListEle,1045)
function btnFunr(dom,width){
    if (parseInt(dom.style.left) + parseInt(dom.offsetWidth) < width) {
        dom.style.left = `${dom.style.left - width}px`//可以减
    } else {
        dom.style.left = `-${dom.offsetWidth - width}px`//最后点不了的时候
    }
}
// function btn_r1Fun(hoursListEle) {
//     console.log(hoursListEle.style.left)
...
//     console.log(ul_list.style.left)
