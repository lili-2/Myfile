...
function getData(a, b, c = '') {
    ...
    let city_result = saveCity.some(item => {
        ...
        console.log(item.data_city === b && item.data_province === a)
    })
...
function judgeCity(dom) {
    console.log(dom.attributes['data-county'].value)
    if (dom.attributes['data-province'].value === dom.attributes['data-city'].value) {
        ...
        pos.innerHTML = `<p data-province = ${dom.attributes['data-province'].value} data-city=${dom.attributes['data-city'].value}} class="pos_data">${dom.attributes['data-city'].value} ${dom.attributes['data-county'].value}</p>`
    }else{
