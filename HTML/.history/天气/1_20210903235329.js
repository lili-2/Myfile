window.onload = function () {
    ...
    function update(data) {
        ...
        for (let i = 0; i <= 7; i++) {
            ...
            // days_top_pic.setAttribute("data-weather", `${data.forecast_24h[i].day_weather_code}`);
        }
        ...
        for (let i = 0; i <= 7; i++) {
            ...
            // night_wind_power
            days_bottom_pic.setAttribute("data-weather", `${data.forecast_24h[i].day_weather_code}`);
