window.onload = function () {
    ...
    function update(data) {
        ...
        // drawcir(100,20)
        console.log(max,maxDegree[0])
        drawcir(unitX,(maxDegree[0] - max)*unitY*(-1) + 20)
        console.log((maxDegree[0] - max)*unitY*(-1) + 20)
        // dirText(`${(maxDegree[0] - max)*unitY*(-1)}px`,`${maxDegree[0]}°`,10,50)
        dirText(`20px`,`${maxDegree[0]}°`,(30 - 10),`${(maxDegree[0] - max)*unitY*(-1)}px`)
