window.onload = function () {
    ...
    function update(data) {
        ...
        btn_r1.addEventListener('click',() => {
            btn_r1Fun(hoursListEle);
        })
        btn_l1.addEventListener('click',() => {
            if(parseInt(hoursListEle.style.left) + hoursListEle.offsetWidth >= 2090){
                ...
                console.log(hoursListEle.style.left + '000')
                hoursListEle.style.left =  `${pageXOffset + 1045}px`
                console.log(hoursListEle.style.left + '1111111111')
            }
