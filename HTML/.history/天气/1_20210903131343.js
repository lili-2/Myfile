window.onload = function () {
    ...
    function update(data) {
        ...
        //左右点击事件
        ul_list.style.left = `100px`
        console.log(ul_list.style.left)
        btn_r1[1].addEventListener('click',() => ul_list.style.left =  `${parseInt(ul_list.style.style.left) - 380}px`)
        btn_l1[1].addEventListener('click',() => ul_list.style.left =  `${parseInt(ul_list.style.style.left) + 380}px`)
    }
    //获取星期几
