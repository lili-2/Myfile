...
function getData(a, b, c = '') {
    ...
    addScriptTag('https://wis.qq.com/weather/common?source=pc&weather_type=observe|forecast_1h|forecast_24h|index|alarm|limit|tips|rise&province=陕西省&city=西安市&county=&callback=upda');
    function upda(data){
        console.log(data)
    }
}
