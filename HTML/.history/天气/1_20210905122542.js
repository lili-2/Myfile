...
function update(data) {
    ...
    for (let i = -2; i <= 23; i++) {
        if (i === -2) {
            ...
            if ((myDate.getHours() - sunrise.slice(0, 2)) <= 1) {
            ...
            if ((myDate.getHours() - sunset.slice(0, 2)) <= 1) {
            ...
            console.log(parseInt(hourDatatime.slice(8, 10)) - parseInt(srTime))
            ...
            if ((parseInt(hourDatatime.slice(8, 10) - parseInt(ssTime))) === 1) {
                hoursListEle.innerHTML += `<li class="hour_data">
                                            <p class="hour_data_time">${data.rise[0].sunrise}</p>
                                            <div class="hour_data_pic" style="background-image: url(https://mat1.gtimg.com/pingjs/ext2020/weather/pc/icon/weather/s.png)"></div>
