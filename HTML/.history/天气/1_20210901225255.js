window.onload = (function () {
    ...
    function update(data) {
        ...
        for (let i = 1; i <= 8; i++) {
            ...
            day78_top.appendChild(days_top_time1)
            day78_top.appendChild(days_top_time2)
            day78_top.appendChild(days_top_tianqi)
            day78_top.appendChild(days_top_pic)
        ...
        hours_data.appendChild(day78_top)
