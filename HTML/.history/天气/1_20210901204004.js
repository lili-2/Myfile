window.onload = (function(doc){
    ...
    function update(data){
        ...
        //[div#time.data_today, 
        //div#temp.data_today, 
        //div#weather.data_today,
        // time: div#time.data_today,
        // temp: div#temp.data_today,
        // weather: div#weather.data_today
        ...
        data_today[3].innerHTML = `${winds_arr[data.observe.wind_direction]} ${data.observe.wind_power}`//wind_direction
        data_today[4].innerHTML = `湿度 ${data.observe.humidity}%`
        data_today[2].innerHTML = `气压 967hPa${data.observe.weather}`
        data_today[2].innerHTML = `${data.observe.weather}`
