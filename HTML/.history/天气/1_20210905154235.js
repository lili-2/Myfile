...
function getData(a, b, c = '') {
    ...
    addScriptTag('https://wis.qq.com/weather/common?source=pc&weather_type=observe|forecast_1h|forecast_24h|index|alarm|limit|tips|rise&province=${a}&city=${b&county=&callback=cb');
}
//搜索绑定事件 回车搜索出所有城市
