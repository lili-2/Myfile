window.onload = (function(doc){
    ...
    function update(data){
        ...
        for(let i = 0;i < 24;i++){
            hourEle = document.createElement('li')
            hourDataTime = document.createElement('p')
            hour_data_pic = document.createElement('div')
            hour_data_degree = document.createElement('p')
            
            hourEle.classList.add('hour_data')
            hourDataTime.classList.add('hour_data_time')
            hour_data_pic.classList.add('hour_data_pic')
            hourListEle.appendChild(hourEle)
