window.onload = (function () {
    ...
    function update(data) {
        ...
        for (let i = 1; i <= 8; i++) {
            ...
            day78_top.classList.add('hour_data_time')
            day78_top.classList.add('hour_data_pic')
            hourDataDegree.classList.add('hour_data_degree')

            day78_top.appendChild(hourDataTime)
            day78_top.appendChild(hourDataPic)
            day78_top.appendChild(hourDataDegree)
