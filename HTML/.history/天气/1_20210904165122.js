window.onload = function () {
    ...
    function updataHis(){
        ...
        // history.forEach((item)=>{
            ...
            hor_item.setAttribute('data-province',hisEle[i].data_province)
            hor_item.setAttribute('data-city',hisEle[i].data_city)
            hor_item.setAttribute('data-county',hisEle[i].data_county)
            hor_item.innerHTML = `${hisEle[i].data_city}`
