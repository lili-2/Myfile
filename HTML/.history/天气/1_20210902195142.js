window.onload = function () {
    ...
    function update(data) {
        ...
        for (let i = 0; i <= 7; i++) {
            ...
            days_bottom_tianqi.innerHTML = `${data.forecast_24h[i].time.slice(5,7)}月${data.forecast_24h[i].time.slice(8,10)}日`
            days_bottom_wind.innerHTML = `${data.forecast_24h[i].day_weather}`
        }
