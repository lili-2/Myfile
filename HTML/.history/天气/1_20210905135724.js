...
guanCity.addEventListener('mouseover',(event) => {
    allC.style.display = 'block'
    // console.log(target)
    event.preventDefault(); 
})
guanCity.addEventListener('mouseouter',(event) => {
    guanCity.style.border = '1px solid black'
    // while(target!=curentTarget){
    allC.style.display = 'none'
    // console.log(target.toElement)
    event.preventDefault(); 
})
// allC.addEventListener('mouseover',() => {
//     allC.style.border = '1px solid black'
//     allC.style.display = 'block'
//     console.log(target)
// })
// allC.addEventListener('mouseout',() => {
//     allC.style.display = 'none'
//     console.log(target)
// })
