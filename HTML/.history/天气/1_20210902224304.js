window.onload = function () {
    ...
    function update(data) {
        ...
        //生活指数
        const lifePic = [`-80px -37px`,`0 -154px`,`-154px -74px`,`-117px -74px`,`-74px -154px`,`-154px -111px`,`-154px -37px`,`-154px 0`,`-37px -43px`,`0 -43px`,`-37px -117px`,`-74px -80px`]
        const lifeText = [`穿衣 舒适`,`雨伞 不打伞`,`钓鱼 较适宜`,`旅游 适宜`,`感冒 极易发`,`洗车较适宜`,`交通 良好`,`空气污染扩散条件`,`运动 适宜`,`防晒 中等`,`舒适度 舒适`,``,``]
        ...
        for (let i = 1; i <= 12; i++) {
            ...
            ulLiP.innerHTML = '穿衣'
            ulLiDpic.style.backgroundPosition = `-80px -37px`
