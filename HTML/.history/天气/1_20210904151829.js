window.onload = function () {
    ...
    if (typeof (localStorage) !== "undefined") {
        console.log(JSON.parse(localStorage.getItem('saveCity')) || null;;)
    } else {
    ...
    function saveCity(value){
        const data = localStorage.getItem("saveCity");
        var concern = JSON.parse(localStorage.getItem('saveCity')) || null;
        console.log(concern)
        concern.push(value)
