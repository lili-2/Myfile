...
search.addEventListener('keydown', function (e, v) {
    ...
    if (e.keyCode === 13) {
        ...
        addScriptTag(`https://wis.qq.com/city/like?source=pc&city=${city}&callback=citycb`);
    }
})
...
// async function get_city(city, source = 'pc') {
    ...
    //     error: function (error) { console.log(error) }
    // });
    // addScriptTag(`https://wis.qq.com/city/like?source=${source}&city=${city}&callback=citycb`);
