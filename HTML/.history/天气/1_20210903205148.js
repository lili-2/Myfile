window.onload = function () {
    ...
    function getData(sheng,shi){
        $.ajax({
            url: `https://wis.qq.com/weather/common?source=pc&weather_type=observe|forecast_1h|forecast_24h|index|alarm|limit|tips|rise&province=${sheng}&city=${shi}&county`,
            // type: "GET",
            dataType: "JSONP",
    ...
    function choose_click(){
        ...
        p.forEach((e,index) => {
            e.addEventListener('click',() => {
                ...
                input.value = ""
                console.log(e.innerHTML.slice(0,2),e.innerHTML.clice)
                // update(e.innerHTML)
            })
        })
    }
