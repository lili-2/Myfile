window.onload = function () {
    ...
    function update(data) {
        ...
        // btn_r1.addEventListener('click',() => {
            if(Number(hoursListEle.style.left) + hoursListEle.offsetWidth < 0){
                hoursListEle.style.left =  - hoursListEle.style.left
            }else{
                hoursListEle.style.left =  `${hoursListEle.style.left - 1140}px`
            }
            console.log(hoursListEle.style.left,hoursListEle.offsetWidth)
            console.log(parseInt(hoursListEle.style.left) + hoursListEle.style.left)
        // })
