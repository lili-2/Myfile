window.onload = function () {
    ...
    hotCity.forEach(function (i) {
        i.addEventListener('click', function () {
            console.log(this.attributes['data-province'].value,)
            console.log(this.attributes['data-province'].value === this.attributes['data-city'].value)
    ...
    function getData(a, b, c = '') {
        ...
        concern.every(item => {
            ...
            // console.log(item !== pos.innerHTML)
            if (pos.innerHTML !== item) {
