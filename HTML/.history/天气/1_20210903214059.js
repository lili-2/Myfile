window.onload = function () {
    ...
    function getData(a,b,c){
        ...
        //     const url = `https://wis.qq.com/weather/common?source=pc&weather_type=observe|forecast_1h|forecast_24h|index|alarm|limit|tips|rise&province=${a}&city=${b}&county`
        // }else if(arguments.length === 3){
        //     const url = `https://wis.qq.com/weather/common?source=pc&weather_type=observe|forecast_1h|forecast_24h|index|alarm|limit|tips|rise&province=${a}&city=${b}&county=${c}`
        // }
        $.ajax({
