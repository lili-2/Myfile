window.onload = function () {
    ...
    function update(data) {
        ...
        for (let i = 0; i <= 7; i++) {
            ...
            days_top_pic.style.backgroundImage = `url(https://mat1.gtimg.com/pingjs/ext2020/weather/pc/icon/weather/night/${data.forecast_24h[i].day_weather_code}.png)`
            console.log(`${data.forecast_24h[i].day_weather_code}`)
        }
        ...
        for (let i = 0; i <= 7; i++) {
            ...
            // night_wind_power
            days_bottom_pic.days_top_pic.style.backgroundImage = `url(https://mat1.gtimg.com/pingjs/ext2020/weather/pc/icon/weather/night/${data.forecast_24h[i].day_weather_code}.png)`
