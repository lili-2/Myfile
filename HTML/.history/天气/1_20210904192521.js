window.onload = function () {
    ...
    function update(data) {
        ...
        today_weatherCode.backgroundImage = url(`https://mat1.gtimg.com/pingjs/ext2020/weather/pc/icon/currentweather/night/${data.observe.weather_code}.png`)
        console.log(today_weatherCode.backgroundImage)
