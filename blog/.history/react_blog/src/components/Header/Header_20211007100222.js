    ...
    return (
        <div className="header">
            <Row type="flex" justify="center" align="middle">
                <Col className="header_item header_">
                    Blog
                </Col>
                ...
                <Col className="header_item header_right">
                    <Menu mode="horizontal">
                        <Link to="/mylist">
                            <Menu.Item><HomeFilled /> 首页</Menu.Item>
                        </Link>
                        <Link to="/visit">
                            <Menu.Item ><FundFilled /> 访客记录</Menu.Item>
                        </Link>
                        <Link to="/write">
                            <Menu.Item ><EditFilled /> 创作中心</Menu.Item>
                        </Link>
                        <Link to="/article">
                            <Menu.Item ><SnippetsFilled /> 内容管理</Menu.Item>
                        </Link>
                    </Menu>
                </Col>
            </Row>
